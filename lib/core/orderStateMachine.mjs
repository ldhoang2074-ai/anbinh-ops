...
/**
 * @param lead {status, id}
 * @param to target status
 * @param facts {hasSentQuote:boolean, hasDeposit:boolean} — server tra DB rồi truyền vào
 */
...
/**
 * @param order {status, vehicleId, driverId, remainingAmount, debtApproved}
 * @param to target status
 * @param ctx {reason}
 */
